...
public class Add_another_organization_StandardPlan extends Xero_Utility{
	...
	String sPathOFScreenshot1 = System.getProperty("user.dir")+"//screenshot/screenshot_Add_another_organization_StandardPlan.png";
	
	public Add_another_organization_StandardPlan() {
	...
	public void StandardPlan(String bname , String iname) throws Exception {
